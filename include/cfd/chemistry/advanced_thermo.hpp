...
public:
    ...
    [[nodiscard]] virtual std::vector<double> activity_coefficients(
        std::span<const int> charge,
...
public:
    ...
    [[nodiscard]] std::vector<double> activity_coefficients(
        std::span<const int> charge,
        std::span<const double> molality,
...
[[nodiscard]] BinaryIdealEquilibrium minimize_binary_ideal_gibbs(
    double standard_mu_a, double standard_mu_b, double temperature);

[[nodiscard]] double langmuir_surface_coverage(double equilibrium_constant, double activity);
[[nodiscard]] double binary_ion_exchange_fraction(double selectivity,
                                                   double activity_a,
                                                   double activity_b);
