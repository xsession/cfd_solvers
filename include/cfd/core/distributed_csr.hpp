...
#include <vector>
namespace cfd::core {
struct HaloEntry {std::size_t global_column{};std::size_t halo_slot{};};
...
private:CsrMatrix matrix_;std::size_t row_begin_{},row_end_{};std::vector<std::size_t>halo_columns_;
};
} // namespace cfd::core
