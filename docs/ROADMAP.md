...
- [ ] local runtime execution on an MPI-equipped machine/runner
...
- [ ] bounded higher-order convection limiters
...
## Phase 5 - Elmer-class FEM

- element catalogue and quadrature
- sparse CSR matrix and matrix-free operator APIs
- iterative solvers/preconditioners
- heat + linear/nonlinear elasticity
- electrostatics and frequency-domain EM
- adaptivity and coupled multiphysics

## Phase 6 - openEMS-class FDTD

- 3-D Yee grid on SYCL
- CPML/PML
- dispersive/anisotropic materials
- excitation/ports/probes
- near-to-far transform
- multi-GPU decomposition

## Phase 7 - Optiland-class optics

- optical system, surfaces and transformations
- batched sequential/non-sequential rays
- glass/material database schema
- coatings and polarization
- aberration/spot/MTF analyses
- optimization
